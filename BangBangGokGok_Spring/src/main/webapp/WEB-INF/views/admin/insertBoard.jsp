        ...
        <form action="insertBoard.do?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="text" name="userId" value="${ username }" id="userId" class="form-control">
                </div>
                <div class="col-6">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <input type="text" name="articleTitle" placeholder="제목" class="form-control" id="articleTitle" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-12">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <textarea id="board_content" name="articleContent" rows="10" class="form-control"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-1">
