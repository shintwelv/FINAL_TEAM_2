...
<body>
	<h1>임시 게시글 보기</h1><br><hr><br>
		...
		게시글 작성 시간 <input type="text" name="transferDate" value="${ TmpBoard.transferDate }"><br><br>
		제목 <input type="text" name="transferName" value="${ TmpBoard.transferName }"/>
		업로드된 파일 : <a href="/admin/download?fileName=${ TmpBoard.transferImage }">${ TmpBoard.transferImage }</a><br><br>  
